...
<footer>
    <div class="container-fluid padding">
        <div class="row text-center">
            <div class="col-md-4">
                <img src="{{ asset('img/hokusei-logo-fix.png') }}" style="height:50px;"> <span style="margin-left:1.5rem;font-size:1.3em;">Hokusei</span>
                <hr class="light">
                <p>0822 6087 9023</p>
                <p><a href="mailto:hokusei.uts@gmail.com">hokusei.uts@gmail.com</a></p>
            ...
            <div class="col-md-4">
                <hr class="light">
                <h5>Pertemuan Rutin</h5>
                <hr class="light">
                <p>Saturday :01:00 PM - 04:00 PM</p>
